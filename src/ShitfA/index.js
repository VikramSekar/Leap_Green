...
function ShiftA() {
    ...
    const handleSubmit4 = async (e) => {
        try {
            ...
            const response = await axios.post('http://localhost:3001/shiftA_remarks', {
    ...
    const handleSubmit3 = async () => {
        try {
            await axios.post("http://localhost:3001/shiftA_commonworks", checkboxes);
        } catch (error) {
            console.error("Error submitting data:", error);
            alert("Error submitting data");
        }
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3001/shiftC_remarkslast') // Assuming you have a GET route to fetch the data
            .then((response) => response.json())
            .then((fetchedData) => {
