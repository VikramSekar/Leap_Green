...
function ShiftB() {
    ...
    const handleSubmit5 = async (e) => {
        try {
            ...
            const response = await axios.post('http://localhost:3001/shiftB_remarks', {
    ...
    const handleSubmit1 = async () => {
        try {
            await axios.post('http://localhost:3001/shiftB_forecast', forecastData);
        } catch (error) {
    ...
    useEffect(() => {
        axios.get('http://localhost:3001/shiftB_demandforecastlast')
            .then(response => {
    ...
    const handleSubmit2 = () => {
        axios
            .post("http://localhost:3001/shiftB_demandforecast", demandForecastData)
            .then(() => {
    ...
    useEffect(() => {
        ...
        fetch('http://localhost:3001/shiftA_remarkslast') // Assuming you have a GET route to fetch the data
            .then((response) => response.json())
            .then((fetchedData) => {
